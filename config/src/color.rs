...
pub struct Palette {
    ...
    pub input_text_replace_mode_fg: Option<ColorSpec>,
    pub input_text_replace_mode_bg: Option<ColorSpec>,
    pub input_text_command_mode_fg: Option<ColorSpec>,
    pub input_text_command_mode_bg: Option<ColorSpec>,
    pub input_text_find_replace_mode_fg: Option<ColorSpec>,
    pub input_text_find_replace_mode_bg: Option<ColorSpec>,
    pub input_text_status_fg: Option<ColorSpec>,
    pub input_text_status_bg: Option<ColorSpec>,
    pub input_text_line_number_fg: Option<ColorSpec>,
    pub input_text_current_line_number_fg: Option<ColorSpec>,
    pub input_text_current_line_fg: Option<ColorSpec>,
    pub input_text_current_line_bg: Option<ColorSpec>,
    pub input_text_search_match_fg: Option<ColorSpec>,
    pub input_text_search_match_bg: Option<ColorSpec>,
    pub input_text_search_current_match_fg: Option<ColorSpec>,
    pub input_text_search_current_match_bg: Option<ColorSpec>,
    pub input_text_last_row_fg: Option<ColorSpec>,
    pub input_text_find_label_fg: Option<ColorSpec>,
    pub input_text_replace_label_fg: Option<ColorSpec>,
    pub input_text_find_replace_colon_fg: Option<ColorSpec>,
    pub input_text_find_replace_separator_fg: Option<ColorSpec>,
    ...
    pub input_text_substitute_match_fg: Option<ColorSpec>,
    pub input_text_substitute_match_bg: Option<ColorSpec>,
    pub input_text_substitute_replacement_fg: Option<ColorSpec>,
    pub input_text_substitute_replacement_bg: Option<ColorSpec>,
    ...
    /// Image selector overlay colors
    pub image_selector_description_fg: Option<ColorSpec>,
    ...
    pub form_checkbox_checked_fg: Option<ColorSpec>,
    pub form_checkbox_bracket_fg: Option<ColorSpec>,
...
impl Palette {
    pub fn overlay_with(&self, other: &Self) -> Self {
        ...
        Self {
            ...
            input_text_replace_mode_fg: overlay!(input_text_replace_mode_fg),
            input_text_replace_mode_bg: overlay!(input_text_replace_mode_bg),
            input_text_command_mode_fg: overlay!(input_text_command_mode_fg),
            input_text_command_mode_bg: overlay!(input_text_command_mode_bg),
            input_text_find_replace_mode_fg: overlay!(input_text_find_replace_mode_fg),
            input_text_find_replace_mode_bg: overlay!(input_text_find_replace_mode_bg),
            input_text_status_fg: overlay!(input_text_status_fg),
            input_text_status_bg: overlay!(input_text_status_bg),
            input_text_line_number_fg: overlay!(input_text_line_number_fg),
            input_text_current_line_number_fg: overlay!(input_text_current_line_number_fg),
            input_text_current_line_fg: overlay!(input_text_current_line_fg),
            input_text_current_line_bg: overlay!(input_text_current_line_bg),
            input_text_search_match_fg: overlay!(input_text_search_match_fg),
            input_text_search_match_bg: overlay!(input_text_search_match_bg),
            input_text_search_current_match_fg: overlay!(input_text_search_current_match_fg),
            input_text_search_current_match_bg: overlay!(input_text_search_current_match_bg),
            input_text_last_row_fg: overlay!(input_text_last_row_fg),
            input_text_find_label_fg: overlay!(input_text_find_label_fg),
            input_text_replace_label_fg: overlay!(input_text_replace_label_fg),
            input_text_find_replace_colon_fg: overlay!(input_text_find_replace_colon_fg),
            input_text_find_replace_separator_fg: overlay!(input_text_find_replace_separator_fg),
            ...
            input_text_substitute_match_fg: overlay!(input_text_substitute_match_fg),
            input_text_substitute_match_bg: overlay!(input_text_substitute_match_bg),
            input_text_substitute_replacement_fg: overlay!(input_text_substitute_replacement_fg),
            input_text_substitute_replacement_bg: overlay!(input_text_substitute_replacement_bg),
            ...
            image_selector_description_fg: overlay!(image_selector_description_fg),
            ...
            form_checkbox_checked_fg: overlay!(form_checkbox_checked_fg),
            form_checkbox_bracket_fg: overlay!(form_checkbox_bracket_fg),
