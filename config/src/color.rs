...
pub struct Palette {
    ...
    pub transient_entry_active_argument_fg: Option<ColorSpec>,
    pub transient_entry_inactive_argument_fg: Option<ColorSpec>,
    pub transient_entry_active_value_fg: Option<ColorSpec>,
    pub transient_entry_non_matching_fg: Option<ColorSpec>,
...
impl Palette {
    pub fn overlay_with(&self, other: &Self) -> Self {
        ...
        Self {
            ...
            transient_entry_active_argument_fg: overlay!(transient_entry_active_argument_fg),
            transient_entry_inactive_argument_fg: overlay!(transient_entry_inactive_argument_fg),
            transient_entry_active_value_fg: overlay!(transient_entry_active_value_fg),
            transient_entry_non_matching_fg: overlay!(transient_entry_non_matching_fg),
