...
pub struct Palette {
    ...
    pub input_text_search_replace_mode_fg: Option<ColorSpec>,
    pub input_text_search_replace_mode_bg: Option<ColorSpec>,
...
impl Palette {
    pub fn overlay_with(&self, other: &Self) -> Self {
        ...
        Self {
            ...
            input_text_search_replace_mode_fg: overlay!(input_text_search_replace_mode_fg),
            input_text_search_replace_mode_bg: overlay!(input_text_search_replace_mode_bg),
