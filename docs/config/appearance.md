...
config.colors = {
  ...
  quick_select_inactive_fg = { AnsiColor = 'White' }, -- {{since('nightly', inline=True)}}
  ...
  input_text_find_replace_mode_fg = { AnsiColor = 'Black' }, -- {{since('nightly', inline=True)}}
  input_text_find_replace_mode_bg = { AnsiColor = 'Olive' }, -- {{since('nightly', inline=True)}}
  ...
  input_text_current_line_fg = { AnsiColor = 'White' }, -- {{since('nightly', inline=True)}}
  input_text_current_line_bg = { AnsiColor = 'Grey' }, -- {{since('nightly', inline=True)}}
